...
fluid_part = Particle(part_num=fluid_part_num[None], part_size=world.g_part_size, is_dynamic=True)
...
# fluid_part.fill_open_stack_with_val(fluid_part.k_vis, val_f(0.002))
...
fluid_part.fill_open_stack_with_val(fluid_part.k_vis, val_f(0.0))
fluid_part.close_stack()
...
bound_part.fill_open_stack_with_val(bound_part.k_vis, val_f(0.4))
