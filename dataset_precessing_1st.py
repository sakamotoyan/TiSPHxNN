...
def gridExport_density(vis=False):
...
# process_strainRate(export_data=True, use_density_mask=False, vis_data='rotation')
# process_density(export_data=False)
# dm_vel = process_vel(export_data=True)

gridExport_density(vis=False)
gridExport_vel(vis=False)
gridExport_strainRate()