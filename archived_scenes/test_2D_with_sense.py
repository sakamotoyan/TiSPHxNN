...
fluid_part_1.fill_open_stack_with_val(fluid_part_1.volume, val_f(fluid_part_1.getObjPartSize()**world.g_dim[None]))
fluid_part_1.fill_open_stack_with_val(fluid_part_1.mass, val_f(fluid_rest_density[None]*fluid_part_1.getObjPartSize()**world.g_dim[None]))
...
fluid_part_2.fill_open_stack_with_val(fluid_part_2.volume, val_f(fluid_part_2.getObjPartSize()**world.g_dim[None]))
fluid_part_2.fill_open_stack_with_val(fluid_part_2.mass, val_f(fluid_rest_density[None]*fluid_part_2.getObjPartSize()**world.g_dim[None]))
...
sense_grid_part.add_module_neighb_search(max_neighb_num=val_i(fluid_part_1.getObjPartNum()*32))
...
def run(loop):
    ...
    while gui.window.running:
        ...
        if gui.op_refresh_window:
            gui.scene_setup()
            if gui.show_bound:
                gui.scene_add_parts(obj_pos=fluid_part_1.pos, obj_color=(1,0.5,0),index_count=fluid_part_1.getObjStackTop(),size=world.g_part_size[None])
                gui.scene_add_parts(obj_pos=fluid_part_2.pos, obj_color=(0,0.5,1),index_count=fluid_part_2.getObjStackTop(),size=world.g_part_size[None])
