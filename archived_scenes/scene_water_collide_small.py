...
fluid_cube_data_1 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-1*denominator, 0.5*denominator), rt=vec2f(1*denominator,1.5*denominator), span=world.g_part_size[None]*1.001)
fluid_cube_data_2 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-1*denominator, -1.5*denominator), rt=vec2f(1*denominator,-0.5*denominator), span=world.g_part_size[None]*1.001)
