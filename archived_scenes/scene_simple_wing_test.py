...
wing_part.fill_open_stack_with_val(wing_part.volume, val_f(wing_part.getObjPartSize()[None]**world.g_dim[None]))
wing_part.fill_open_stack_with_val(wing_part.mass, val_f(bound_rest_density[None]*wing_part.getObjPartSize()[None]**world.g_dim[None]))
...
sense_grid_part.add_module_neighb_search(max_neighb_num=val_i(fluid_part.getObjPartNum()[None]*32))
    ...
    while gui.window.running:
        ...
        if gui.op_refresh_window:
            ...
            if gui.show_bound:
                ...
                gui.scene_add_parts(obj_pos=wing_part.pos, obj_color=(1,0.5,0),index_count=wing_part.getObjStackTop()[None],size=world.g_part_size[None])
                gui.scene_add_parts(obj_pos=bound_part.pos, obj_color=(0,1,1),index_count=bound_part.getObjStackTop()[None],size=world.g_part_size[None])
            else:
