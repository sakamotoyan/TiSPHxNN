...
model.train_vorticityBased(num_epochs=40000, network_model_path=model_path, strategy=strategy, former_model_file_path=model_file, save_step=100, freeze_param=if_freeze_parameters)
