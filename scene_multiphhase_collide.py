...
fluid_part.add_solver_ism(Cd=0.0, Cf=0.0, k_vis_inter=kinematic_viscosity_fluid_inter[None], k_vis_inner=kinematic_viscosity_fluid_inner[None])
...
def loop():
    ...
    fluid_part.m_solver_ism.statistics_momentum()
