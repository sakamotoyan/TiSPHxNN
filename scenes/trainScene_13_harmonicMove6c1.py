...
if(MODE == mode.DEBUG): part_size *= 20
...
fluid_cube_data_1 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-5.0, -4+span), rt=vec2f(5.0, 5.5), span=span)
...
box_data   = Box_data(lb=vec2f(-6.2, -4), rt=vec2f(6.2, 6), span=world.getPartSize()*1.001, layers=3)
rod_data_1 = Box_data(lb=vec2f(-6.0,  1.5), rt=vec2f(-5.5,  3.0), span=world.getPartSize()*1.001, layers=3)
rod_data_2 = Box_data(lb=vec2f(-6.0, -1.0), rt=vec2f(-5.5,  0.5), span=world.getPartSize()*1.001, layers=3)
rod_data_3 = Box_data(lb=vec2f(-6.0, -3.5), rt=vec2f(-5.5, -2.0), span=world.getPartSize()*1.001, layers=3)
rod_data_4 = Box_data(lb=vec2f( 5.5,  1.5), rt=vec2f( 6.0,  3.0), span=world.getPartSize()*1.001, layers=3)
rod_data_5 = Box_data(lb=vec2f( 5.5, -1.0), rt=vec2f( 6.0,  0.5), span=world.getPartSize()*1.001, layers=3)
rod_data_6 = Box_data(lb=vec2f( 5.5, -3.5), rt=vec2f( 6.0, -2.0), span=world.getPartSize()*1.001, layers=3)
...
rod_part_1.fill_open_stack_with_val(rod_part_1.size, rod_part_1.getPartSize())
rod_part_1.fill_open_stack_with_val(rod_part_1.volume, rod_part_1.getPartSize()**world.getDim())
rod_part_1.fill_open_stack_with_val(rod_part_1.mass, rod_rest_density*rod_part_1.getPartSize()**world.getDim())
...
rod_part_2.fill_open_stack_with_val(rod_part_2.size, rod_part_2.getPartSize())
rod_part_2.fill_open_stack_with_val(rod_part_2.volume, rod_part_2.getPartSize()**world.getDim())
rod_part_2.fill_open_stack_with_val(rod_part_2.mass, rod_rest_density*rod_part_2.getPartSize()**world.getDim())
...
rod_part_3.fill_open_stack_with_val(rod_part_3.size, rod_part_3.getPartSize())
rod_part_3.fill_open_stack_with_val(rod_part_3.volume, rod_part_3.getPartSize()**world.getDim())
rod_part_3.fill_open_stack_with_val(rod_part_3.mass, rod_rest_density*rod_part_3.getPartSize()**world.getDim())
...
rod_part_4 = Particle(part_num=rod_data_4.num, part_size=world.g_part_size, is_dynamic=False)
world.attachPartObj(rod_part_4)
rod_part_4.instantiate_from_template(part_template, world)
rod_part_4.open_stack(rod_data_4.num)
rod_part_4.fill_open_stack_with_arr(rod_part_4.pos, rod_data_4.pos)
rod_part_4.fill_open_stack_with_val(rod_part_4.size, rod_part_4.getPartSize())
rod_part_4.fill_open_stack_with_val(rod_part_4.volume, rod_part_4.getPartSize()**world.getDim())
rod_part_4.fill_open_stack_with_val(rod_part_4.mass, rod_rest_density*rod_part_4.getPartSize()**world.getDim())
rod_part_4.fill_open_stack_with_val(rod_part_4.rest_density, rod_rest_density)
rod_part_4.fill_open_stack_with_val(rod_part_4.rgb, vec3f([0.0, 0.0, 0.0]))
rod_part_4.fill_open_stack_with_val(rod_part_4.k_vis, k_vis)
rod_part_4.close_stack()

rod_part_5 = Particle(part_num=rod_data_5.num, part_size=world.g_part_size, is_dynamic=False)
world.attachPartObj(rod_part_5)
rod_part_5.instantiate_from_template(part_template, world)
rod_part_5.open_stack(rod_data_5.num)
rod_part_5.fill_open_stack_with_arr(rod_part_5.pos, rod_data_5.pos)
rod_part_5.fill_open_stack_with_val(rod_part_5.size, rod_part_5.getPartSize())
rod_part_5.fill_open_stack_with_val(rod_part_5.volume, rod_part_5.getPartSize()**world.getDim())
rod_part_5.fill_open_stack_with_val(rod_part_5.mass, rod_rest_density*rod_part_5.getPartSize()**world.getDim())
rod_part_5.fill_open_stack_with_val(rod_part_5.rest_density, rod_rest_density)
rod_part_5.fill_open_stack_with_val(rod_part_5.rgb, vec3f([0.0, 0.0, 0.0]))
rod_part_5.fill_open_stack_with_val(rod_part_5.k_vis, k_vis)
rod_part_5.close_stack()

rod_part_6 = Particle(part_num=rod_data_6.num, part_size=world.g_part_size, is_dynamic=False)
world.attachPartObj(rod_part_6)
rod_part_6.instantiate_from_template(part_template, world)
rod_part_6.open_stack(rod_data_6.num)
rod_part_6.fill_open_stack_with_arr(rod_part_6.pos, rod_data_6.pos)
rod_part_6.fill_open_stack_with_val(rod_part_6.size, rod_part_6.getPartSize())
rod_part_6.fill_open_stack_with_val(rod_part_6.volume, rod_part_6.getPartSize()**world.getDim())
rod_part_6.fill_open_stack_with_val(rod_part_6.mass, rod_rest_density*rod_part_6.getPartSize()**world.getDim())
rod_part_6.fill_open_stack_with_val(rod_part_6.rest_density, rod_rest_density)
rod_part_6.fill_open_stack_with_val(rod_part_6.rgb, vec3f([0.0, 0.0, 0.0]))
rod_part_6.fill_open_stack_with_val(rod_part_6.k_vis, k_vis)
rod_part_6.close_stack()
...
rod_part_4.add_module_neighb_search()
rod_part_5.add_module_neighb_search()
rod_part_6.add_module_neighb_search()
...
rod_part_4.add_neighb_objs(neighb_list)
rod_part_5.add_neighb_objs(neighb_list)
rod_part_6.add_neighb_objs(neighb_list)
...
rod_part_4.add_solver_sph()
rod_part_4.add_solver_adv()
rod_part_4.add_solver_df(div_free_threshold=1e-4)

rod_part_5.add_solver_sph()
rod_part_5.add_solver_adv()
rod_part_5.add_solver_df(div_free_threshold=1e-4)

rod_part_6.add_solver_sph()
rod_part_6.add_solver_adv()
rod_part_6.add_solver_df(div_free_threshold=1e-4)
...
def loop(is_log_loop=False):
    ...
    rod_part_1.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.5, amplitude=0.5, world_time=world.getTime(), delay=0.0)
    rod_part_2.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.6, amplitude=0.5, world_time=world.getTime(), delay=0.0)
    rod_part_3.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.7, amplitude=0.5, world_time=world.getTime(), delay=0.0)
    rod_part_4.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.7, amplitude=0.5, world_time=world.getTime(), delay=0.0)
    rod_part_5.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.4, amplitude=0.5, world_time=world.getTime(), delay=0.0)
    rod_part_6.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.45, amplitude=0.5, world_time=world.getTime(), delay=0.0)
...
def run(loop):
    ...
    gui2d_part = Gui2d(objs=[fluid_part, bound_part, rod_part_1, rod_part_2, rod_part_3, rod_part_4, rod_part_5, rod_part_6], radius=world.getPartSize(), lb=vec2f([-8,-8]),rt=vec2f([8,8]),dpi=dpi)
    gui2d_grid = Gui2d(objs=[sense_grid_part], radius=sense_grid_part.getPartSize(), lb=vec2f([-8,-8]),rt=vec2f([8,8]), dpi=dpi)
