...
def loop(is_log_loop=False):
    ...
    rod_part_1.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=2, amplitude=1.0, world_time=world.getTime(), delay=1)
    rod_part_2.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=2, amplitude=1.0, world_time=world.getTime(), delay=0.5)
    rod_part_3.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=2, amplitude=1.0, world_time=world.getTime(), delay=0)
