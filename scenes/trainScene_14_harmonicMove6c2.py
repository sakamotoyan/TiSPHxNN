...
def loop(is_log_loop=False):
    ...
    rod_part_1.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.5, amplitude=0.2, world_time=world.getTime(), delay=0.1)
    rod_part_2.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.3, amplitude=0.5, world_time=world.getTime(), delay=0.2)
    rod_part_3.getSolverAdv().add_acc_harmonic(axis=0, dir = -1, period=0.7, amplitude=0.5, world_time=world.getTime(), delay=0.3)
    rod_part_4.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.7, amplitude=0.4, world_time=world.getTime(), delay=0.1)
    rod_part_5.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.4, amplitude=0.7, world_time=world.getTime(), delay=0.3)
    rod_part_6.getSolverAdv().add_acc_harmonic(axis=0, dir =  1, period=0.4, amplitude=0.5, world_time=world.getTime(), delay=0.2)
