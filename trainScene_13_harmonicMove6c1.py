...
output_path = os.path.join('/workspace/dataset/raw_t13')
...
rod_part_4.fill_open_stack_with_val(rod_part_4.size, rod_part_4.getObjPartSize())
rod_part_4.fill_open_stack_with_val(rod_part_4.volume, rod_part_4.getObjPartSize()**world.getWorldDim())
rod_part_4.fill_open_stack_with_val(rod_part_4.mass, rod_rest_density*rod_part_4.getObjPartSize()**world.getWorldDim())
...
rod_part_5.fill_open_stack_with_val(rod_part_5.size, rod_part_5.getObjPartSize())
rod_part_5.fill_open_stack_with_val(rod_part_5.volume, rod_part_5.getObjPartSize()**world.getWorldDim())
rod_part_5.fill_open_stack_with_val(rod_part_5.mass, rod_rest_density*rod_part_5.getObjPartSize()**world.getWorldDim())
...
rod_part_6.fill_open_stack_with_val(rod_part_6.size, rod_part_6.getObjPartSize())
rod_part_6.fill_open_stack_with_val(rod_part_6.volume, rod_part_6.getObjPartSize()**world.getWorldDim())
rod_part_6.fill_open_stack_with_val(rod_part_6.mass, rod_rest_density*rod_part_6.getObjPartSize()**world.getWorldDim())
...
def run(loop):
    ...
    gui2d_part = Gui2d(objs=[fluid_part, bound_part, rod_part_1, rod_part_2, rod_part_3, rod_part_4, rod_part_5, rod_part_6], radius=world.getWorldPartSize(), lb=vec2f([-8,-8]),rt=vec2f([8,8]),dpi=dpi)
