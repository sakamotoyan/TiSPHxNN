...
fluid_cube_data_1 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-3, -3), rt=vec2f(-2, 2), span=world.g_part_size[None]*1.001)
fluid_cube_data_2 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-1.5, -3), rt=vec2f(0.5, 2), span=world.g_part_size[None]*1.001)
fluid_cube_data_3 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(1, -3), rt=vec2f(2, 2), span=world.g_part_size[None]*1.001)
