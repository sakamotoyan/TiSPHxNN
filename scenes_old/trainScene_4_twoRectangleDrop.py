...
fluid_cube_data_1 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-4+part_size*3, -4+part_size*3), rt=vec2f(4-part_size*3, -2), span=world.g_part_size[None]*1.001)
...
fluid_cube_data_3 = Cube_data(type=Cube_data.FIXED_CELL_SIZE, lb=vec2f(-3, -1.8), rt=vec2f(-1, 3.5), span=world.g_part_size[None]*1.001)
